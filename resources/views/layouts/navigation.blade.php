        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('colors.index')" :active="request()->routeIs('colors.*')">Colors</x-nav-link>
                    <x-nav-link :href="route('materials.index')" :active="request()->routeIs('materials.*')">Materials</x-nav-link>
                    <x-nav-link :href="route('brands.index')" :active="request()->routeIs('brands.*')">Brands</x-nav-link>
